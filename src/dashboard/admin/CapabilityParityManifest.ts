...
export const capabilityParityManifest: readonly CapabilityParityEntry[] = [
  ...
  { id: "controlled-mutation.execution-and-recovery", status: "INTENTIONAL_CLI_ONLY", surfaces: ["CLI"], reason: "Initial release keeps state-changing authorization and encrypted crash recovery on the local operator boundary while dashboard approval APIs are hardened.", owner: "authorized security operator", safety: "Requires an expiring contract, disposable target, exact endpoint/field/value allowlists, a global lock, independent verification, and mandatory rollback." },
