...
export class ProofPackService {
  ...
  public generate(title: string, description: string | undefined, findingIds: readonly string[]): string {
    ...
    const markdown = renderMarkdown(title, description, selected);
    const html = renderHtml(title, description, selected);
...
function renderMarkdown(title: string, description: string | undefined, selected: readonly SelectedProofFinding[]): string {
...
function renderHtml(title: string, description: string | undefined, selected: readonly SelectedProofFinding[]): string {
